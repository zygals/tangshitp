				...
				<div class="">
					<div class="container-fluid" id="fields_div">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-8">
                                <input type="text" class="form-control input-sm duiqi" name='address' value="" id="" placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-8">
                                <input type="text" class="form-control input-sm duiqi" name='start_time' value="" id="" placeholder="如9:20:00">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="sKnot" class="col-xs-3 control-label"><span style="color:red;">*&nbsp;&nbsp;</span>歇业时间：</label>
                            <div class="col-xs-8">
                                <input type="text" class="form-control input-sm duiqi" name='end_time' value="" id="" placeholder="如22:20:00">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="sKnot" class="col-xs-3 control-label"><span style="color:red;">*&nbsp;&nbsp;</span>可容纳人数：</label>
                            <div class="col-xs-8">
                                <input type="text" class="form-control input-sm duiqi" name='galleryful' value="" id="" placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
